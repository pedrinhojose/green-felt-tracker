      ...
      <AlertDialog>
        <AlertDialogTrigger asChild>
          <Button
            ...
            variant="outline"
            className="w-full bg-poker-navy/40 backdrop-blur-sm hover:bg-poker-navy/60 border border-white/20 rounded-xl"
          >
            {isRestoring ? (
              <>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Esta ação irá sobrescrever todos os dados existentes com o backup selecionado: <strong>{selectedFile.name}</strong>
                <br />
                <br />
