...
export default function RankingExporter({ sortedRankings, activeSeason, getInitials, getMedalEmoji }: RankingExporterProps) {
  ...
  const handleExportRanking = async () => {
    try {
      ...
      (exportDiv as HTMLElement).style.maxWidth = '430px';  // Reduz ainda mais a largura máxima
      ...
      tableElement.style.fontSize = '13px'; // Fonte ainda menor
      ...
      const headerWidths = ['36px', '130px', '40px', '50px']; // Larguras ajustadas para cada coluna
      ...
      sortedRankings.forEach((ranking, index) => {
        ...
        playerCell.style.maxWidth = '130px';
