...
import { AutoGenerateDialog, SeasonDefaults } from "./host-schedule/AutoGenerateDialog";
...
export function HostScheduleConfig({ hostSchedule, onChange, seasonDefaults }: HostScheduleConfigProps) {
  const {
    isAutoGenerateOpen,
